...
def quantitats_de(nom, alt="def"):
    ...
    exercicis = {
        ...
        "EQ_SEGON_BIQUADRADES": [0, 3, 6, 9, 15, 33, 66],
        "EQ_SEGON_COMPLETES": [0, 3, 6, 9, 15, 33, 66],
        "EQ_SEGON_INCOMPLETES": [0, 6, 9, 12, 15, 33, 66],
        "EQ_SEGON_OPERAIRESOL": [0, 2, 4, 8, 10, 22, 44],
        "EQ_SEGON_TRIQUADRADES": [0, 3, 6, 9, 15, 33, 66],
        ...
        "POWSQR_SQR_INDEXCOMUMULTI": {"def": [0, 3, 6, 12, 21, 51, 105],
                                      "mc2": [0, 2, 4, 6, 14, 32, 70],
                                      }.get(alt, default),
